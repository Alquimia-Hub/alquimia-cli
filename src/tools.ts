import type { Tool, ToolInstall, ToolSection } from "./types.ts";
 ...
 */
export function toolHasInstall(tool?: Tool | null): boolean {
 ...
 */
export function findToolSection(id?: string | null): ToolSection | null {
  if (!id) return null;
...
export interface ToolSectionPayload {
  id: string;
  name: string;
  blurb: string;
  tools: ToolPayload[];
...
export function toolsCatalogPayload(): { sections: ToolSectionPayload[] } {
  return {
 ...
 */
export function isToolOpenable(tool?: Tool | null): boolean {
